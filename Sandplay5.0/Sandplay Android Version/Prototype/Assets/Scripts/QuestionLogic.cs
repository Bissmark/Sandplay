...
public class QuestionLogic : MonoBehaviour
{
	...
	void Start () 
	{
		//mainScript = (GameObject.Find("sandBoxFullMB") as GameObject).GetComponent<ObjectSpawner>();
		//questionEnable = (GameObject.Find("sandBoxFullMB") as GameObject).GetComponent<Questions>();
		//objectsTween = (GameObject.Find("ObjectsButton") as GameObject).GetComponent<UIPlayTween>();
	...
	public void HideContent ()
	{
		...
		//neutralButton.SetActiveRecursively(false);
		//positiveButton.SetActiveRecursively(false);
		//negativeButton.SetActiveRecursively(false);
		//inputBox.SetActiveRecursively(false);
	}
	...
	public void UpdateContent () 
	{
		...
		//mainScript.CurrentState = SPAWN_STATE.NOT_SPAWNING;
	}
		...
		else
		{
			switch(contentIndex)
			{
				...
				case 1:
					...
					//mainScript.CurrentState = SPAWN_STATE.NOT_SPAWNING;
					//if (mainScript.piecePlaced = true)
					//{
					//	goto case 2;
					//}
					//goto case 2;
